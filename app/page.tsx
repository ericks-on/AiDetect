...
export default function Home() {
  ...
  return (
    <main className="flex flex-col w-screen items-center pt-20">
      ...
      <TextForm setResults={setResults} setRate={setRate}/>
      {/* results either ai generated or not */}
      <div className="flex flex-col w-1/2 mt-8">
        <h2 className="text-xl">Results:</h2>
        <div className="border p-4 mt-2 rounded">
          {results === 0? <p className="text-green-500">Not AI generated</p> : results === 1? <p className="text-red-500">{rate * 100}% chance that text is AI generated</p> : <p>Results will appear here</p>}
        </div>
      </div>
    </main>
  );
